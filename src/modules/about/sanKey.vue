    ...
    return {
      ...
      paramDescription: {
        ...
        data: [
          ...
          {
            name: "color",
            description: "配置的颜色。如果没有配置颜色域，设置一个颜色。否则可以设置一系列颜色，也可以使用回调函数。默认:主题的颜色板。",
            type: "string | string[] | Function",
            protocol:'optional',
          },
          {
            name: "nodeWidthRatio",
            description: "桑基图节点的宽度配置，0 ~ 1，参考画布的宽度，默认为 0.008。",
            type: "number",
            protocol:'optional',
          },
          {
            name: "nodeWidthPadding",
            description: "桑基图节点的之间垂直方向的间距，0 ~ 1，参考画布的高度，默认为 0.01。",
            type: "number",
            protocol:'optional',
          },
          {
            name: "nodeAlign",
            description: "桑基图节点的布局方向，默认为 justify，可以选择 'left' | 'right' | 'center' | 'justify' 四种方式。",
            type: "string",
            protocol:'optional',
          },
        ],
